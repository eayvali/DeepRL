...
UPDATE_AFTER=BATCH_SIZE  # Number of env interactions to collect before starting to do gradient descent updates
...
class Agent():
    ...
    def __init__(self, state_size, action_size,num_agents, random_seed):
        ...
        print('Created an Actor and a Critic \n',self.actor_local,self.critic_local)
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if len(self.memory) > UPDATE_AFTER and self.total_steps % UPDATE_EVERY==0:
...
#                print("action_after_noise",action)
            ...
            action=np.random.uniform(-1,1,(self.num_agents,self.action_size))#num_agentsxaction_size
